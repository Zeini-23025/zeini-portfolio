document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ...
        ar: {
            ...
            'about.title': 'من أنا',
            'about.subtitle': 'متخصص في تطوير نظم المعلومات في المعهد العالي للتقنيات الرقمية. أسعى لتحويل الأفكار المعقدة إلى تطبيقات ويب فعالة وسهلة الاستخدام، ودائمًا أبحث عن تحديات لتطوير مهاراتي والمساهمة في مشاريع مبتكرة.',
